    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
        <div>
          ...
          <p className="text-gray-400 text-sm">Define and manage your agency's core offerings and pricing.</p>
        </div>
      ...
      {/* Services List - Modern Grid/Rows */}
      <div className="grid gap-4">
        {services.map(service => (
          <div 
            key={service.id} 
            className="group bg-gray-900/30 backdrop-blur-sm hover:bg-gray-800/40 border border-gray-800 hover:border-gray-700 p-6 rounded-2xl transition-all duration-300"
          >
